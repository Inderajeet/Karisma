...
const DentalRelatedServices = () => {
    const { t, i18n } = useTranslation('dentalRelated');
    const { serviceName, subService } = useParams(); // Extract category & sub-service

    const [service, setService] = useState(null);

    useEffect(() => {
        const servicesData = t('dentalRelated:dentalRelated', { returnObjects: true });
    ...
    return (
        <>
            ...
            <div className="line-container" style={{ display: 'flex', width: '100%', justifyContent: 'center', paddingTop: '40px' }}>
...
export default DentalRelatedServices;
