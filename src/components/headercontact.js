  ...
  return (
    <>
      ...
      <div className="happysmile-body-inner">
            ...
            <div className="header-mobilebar navbar">
              <div className="container">
                <ul className="nav mobilebar element-left right-element-exist">
                  {" "}
                  <li
                    className={`header-mobile-toggle-wrapper mobile-menu-floating ${isMenuActive ? "mobile-menu-active" : ""
                      }`}
                  >
                    <div
        ...
        <div className={`mobile-menu-floating ${isMenuActive ? "mobile-menu-active" : ""}`}>
          <a href="#" className="mobile-menu-toggle" onClick={(e) => {
