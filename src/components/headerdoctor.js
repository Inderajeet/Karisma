    ...
    <div className="icon">
      <img src="./assets/Images/lan/lang1.png" alt="Arabic" />
          ...
          <div className="al_home">
            <ul class="OnlineBookingfixed floating"><a><li style={{color:'white', fontFamily:' "Tajawal variant2", Tofu'}}>APPOINTMENT</li></a></ul>
                                ...
                                <div className="section-title-wrapper">
                                  <div className="title-wrap">
                                    ...
                                    <h2 className="section-title">
                                      Achieving Dental Wellness and Radiant
                                      Confidence
                                    </h2>
                                  </div>
                                  {/* .title-wrap */}
                                  <div className="section-description">
                                    <p className="section-content">
                                      Welcome to our office! Our dentists and
                                      team are looking forward to caring for you
                                      and your smile. We understand just how
                                      closely connected oral health is to your
                                      overall health, confidence, and
                                      appearance, and we pride ourselves on
                                ...
                                <div className="elementor-widget-container">
                                  <div className="section-title-wrapper">
                                    <div className="title-wrap">
                                      ...
                                      <h2 className="section-title">
                                        Friendly Faces, Personalized Care for
                                        Your Smile{" "}
                                      </h2>
                                    </div>
                                    {/* .title-wrap */}
                                          ...
                                          <div className="team-inner">
                                            ...
                                            <div className="post-details-outer">
                                              ...
                                              <div className="post-excerpt">
                                                Working Experience Lorem ipsum
