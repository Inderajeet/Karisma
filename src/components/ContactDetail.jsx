                  ...
                  <div className="elementor-widget-container feature-box-wrapper feature-box-classic contact-box">
                    <div className="media" style={{ display: 'flex' }}>
                      <div className="media-icon-part">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 68 78"><g id="chat" transform="translate(0.327 0.071)"><g id="Ellipse_89" data-name="Ellipse 89" transform="translate(-0.327 -0.071)" fill="#405d53" stroke="none" stroke-width="0"><circle cx="34" cy="34" r="34" stroke="none"></circle><circle cx="34" cy="34" r="33.5" fill="none"></circle></g><path id="Path_10022" data-name="Path 10022" d="M166.512,150.708c-.28-.158-.6-.336-.979-.566-.213-.129-.481-.305-.766-.492-1.459-.958-2.564-1.636-3.5-1.636a1.711,1.711,0,0,0-.619.111,5.983,5.983,0,0,0-2.156,1.987,10.536,10.536,0,0,1-.791.924,15.567,15.567,0,0,1-7.562-7.57,10.458,10.458,0,0,1,.928-.8,5.993,5.993,0,0,0,1.981-2.15c.407-1.057-.339-2.32-1.524-4.127-.187-.284-.363-.553-.491-.765-.231-.384-.409-.7-.567-.981-.646-1.149-1.073-1.909-2.677-1.909-1.041,0-2.513.985-3.511,1.961a6.667,6.667,0,0,0-2.247,4.618c0,4.236,2.365,9.09,6.48,13.323.007.007.014.009.021.016,4.23,4.119,9.084,6.475,13.316,6.475h0a6.646,6.646,0,0,0,4.613-2.239c.977-1,1.962-2.46,1.962-3.5C168.419,151.782,167.66,151.355,166.512,150.708Z" transform="translate(-121.351 -111.806)" fill="#fff"></path></g></svg>
                      </div>
                  ...
                  <div className="elementor-widget-container feature-box-wrapper feature-box-classic contact-box">
                    <div className="media" style={{ display: 'flex' }}>
                      <div className="media-icon-part">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 68 68">
                          <circle cx="34" cy="34" r="34" fill="#405d53"></circle>

                          <path fill="#fff" d="M17 24C17 22.8954 17.8954 22 19 22H49C50.1046 22 51 22.8954 51 24V44C51 45.1046 50.1046 46 49 46H19C17.8954 46 17 45.1046 17 44V24ZM21 25.3333V44H47V25.3333L34 33.6667L21 25.3333ZM23.2 24H44.8L34 30.6667L23.2 24Z"></path>
                        </svg>
