...
export default function Footer() {
  ...
  const service = [
    { name: "Privacy Policy", link: "/en/privacy-policy" },
    { name: "Cookie Policy", link: "/en/cookie-policy" },
    { name: "Terms and conditions", link: "/en/terms-conditions" },
  ];
                                  ...
                                  <svg id="instagram" xmlns="http://www.w3.org/2000/svg" width="23.72" height="23.72" viewBox="0 0 23.72 23.72">
                                    <g id="Group_183" data-name="Group 183" transform="translate(0)">
                                      <g id="Group_182" data-name="Group 182">
                                        <path id="Path_143" data-name="Path 143" d="M17.795,0H5.935A5.948,5.948,0,0,0,0,5.93V17.79a5.948,5.948,0,0,0,5.93,5.93h11.86a5.948,5.948,0,0,0,5.93-5.93V5.93A5.948,5.948,0,0,0,17.795,0Zm3.953,17.79a3.958,3.958,0,0,1-3.953,3.953H5.935A3.958,3.958,0,0,1,1.982,17.79V5.93A3.958,3.958,0,0,1,5.935,1.977h11.86A3.957,3.957,0,0,1,21.748,5.93V17.79Z" transform="translate(-0.005 0)"></path>
                                      </g>
                                    </g>
                                    <g id="Group_185" data-name="Group 185" transform="translate(16.802 3.953)">
                                      <g id="Group_184" data-name="Group 184">
                                        <ellipse id="Ellipse_14" data-name="Ellipse 14" cx="1.482" cy="1.482" rx="1.482" ry="1.482"></ellipse>
                                      </g>
                                    </g>
                                    <g id="Group_187" data-name="Group 187" transform="translate(5.93 5.93)">
                                      <g id="Group_186" data-name="Group 186">
                                        <path id="Path_144" data-name="Path 144" d="M108.335,102.4a5.93,5.93,0,1,0,5.93,5.93A5.929,5.929,0,0,0,108.335,102.4Zm0,9.884a3.953,3.953,0,1,1,3.953-3.954A3.953,3.953,0,0,1,108.335,112.284Z" transform="translate(-102.405 -102.4)"></path>
                                      </g>
                                    </g>
                                  </svg>
                                  ...
                                  <svg id="Group_176" data-name="Group 176" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="22.755" height="21.749" viewBox="0 0 22.755 21.749">
                                    <defs>
                                      <clipPath id="clip-path">
                                        <rect id="Rectangle_91" data-name="Rectangle 91" width="22.754" height="21.749"></rect>
                                      </clipPath>
                                    </defs>
                                    <g id="Group_175" data-name="Group 175">
                                      <g id="Group_174" data-name="Group 174" clip-path="url(#clip-path)">
                                        <path id="Path_139" data-name="Path 139" d="M2.759,0A2.542,2.542,0,1,0,2.7,5.071h.032A2.543,2.543,0,1,0,2.759,0"></path>
                                        <rect id="Rectangle_90" data-name="Rectangle 90" width="4.878" height="14.675" transform="translate(0.288 7.074)"></rect>
                                        <path id="Path_140" data-name="Path 140" d="M230.273,189.108c-2.631,0-4.4,2.473-4.4,2.473v-2.128H221v14.675h4.878v-8.195a3.343,3.343,0,0,1,.161-1.19,2.67,2.67,0,0,1,2.5-1.784c1.765,0,2.471,1.346,2.471,3.318v7.85h4.877v-8.414c0-4.507-2.407-6.6-5.616-6.6" transform="translate(-213.134 -182.378)"></path>
                                      </g>
                                    </g>
                                  </svg>
