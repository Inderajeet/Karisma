                                ...
                                <div className="row team">
                                    ...
                                    <div className="col-sm-7 team-info">
                                        <div className="team-title">
                                            <div style={{fontSize:"30px"}}>{teamData.name}</div>
                                            <div className="team-designation-wrap">
                                                <span className="team-designation">{teamData.designation}</span>
                                            </div>
                                        </div>
                                                ...
                                                <div className="col-md-6 team-email-wrap">
                                                    <div className="team-media media">
                                                        ...
                                                        <div className="media-body">
                                                            ...
                                                            <a href={`mailto:${teamData.email}`} className="team-email">
                                                                {teamData.email}
                                                            </a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="col-md-6 team-phone-wrap">
                                                    <div className="team-media media">
                                                        ...
                                                        <div className="media-body">
                                                            ...
                                                            <a href={`tel:${teamData.phone}`} className="team-phone">
                                                                {teamData.phone}
                                                            </a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="col-md-6 team-website-wrap">
                                                    <div className="team-media media">
                                                        ...
                                                        <div className="media-body">
                                                            ...
                                                            <a href={teamData.website} className="team-website">
                                                                {teamData.website}
                                                            </a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="col-md-6 team-experience-wrap">
                                                    <div className="team-media media">
                                                        ...
                                                        <div className="media-body">
                                                            ...
                                                            <span className="team-experience">{teamData.experience}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <ul className="nav cust-social-icons team-social">
                                                ...
                                                <li>
                                                    <a
                                                        ...
                                                        href={teamData.socialLinks.youtube}
                                                        target="_blank"
                                                        rel="noopener noreferrer"
                                                    >
                                                                ...
                                                                <div className="e-con-inner">
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div className="e-con-inner">
                                                                            ...
                                                                            {/* Overview sections*/}
                                                                            {teamData.overview.sections.map((section, sectionIndex) => (
                                                                            ...
                                                                            >
                                                                                <div className="elementor-widget-container">
                                                                                    <div className="section-title-wrapper">
                                                                                        <div className="title-wrap">
                                                                                            <h4 className="section-title">
                                                                                            {teamData.qualifications.title}
                                                                                            </h4>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="elementor-element elementor-element-653e731 elementor-widget__width-initial elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list" data-id="653e731" data-element_type="widget" data-widget_type="icon-list.default">
                                                                                <div class="elementor-widget-container">
                                                                                    <ul class="elementor-icon-list-items">
                                                                                        {teamData.qualifications.items.map((detail, index) => (
                                                                                            <li class="elementor-icon-list-item">
                                                                                                <span class="elementor-icon-list-icon">
                                                                                                    <i aria-hidden="true" class=" bi-check2-circle">
                                                                                                    </i>
                                                                                                </span>
                                                                                                <span class="elementor-cust-icon-list-text">{detail}</span
                                                                                                >
                                                                                            </li>
                                                                                        ))}
                                                                                    </ul>
                                                                    ...
                                                                    >
                                                                        <div className="e-con-inner">
                                                                            ...
                                                                            >
                                                                                <div className="elementor-widget-container">
                                                                                    <ul className="elementor-icon-list-items">
                                                                                    {teamData.workExperience.items.map((detail, index) => (
                                                                                                    ...
                                                                                                    <div className="flip-box-inner imghvr-flip-horiz">
                                                                                                        <div className="flip-front">
                                                                                                            <div className="flip-front-inner">
                                                                                                                ...
                                                                                                                {teamData.workingShifts.flipFront1}
                                                                                                                </h4>
                                                                                                                <div className="flip-content">
                                                                                                                {teamData.workingShifts.flipFrontDesc1}
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            {/* .flip-front-inner */}
                                                                                                        </div>
                                                                                                        ...
                                                                                                        <div className="flip-back">
                                                                                                            <div className="flip-back-inner">
                                                                                                                ...
                                                                                                                <h4 className="flip-box-title">
                                                                                                                {teamData.workingShifts.flipBack1}
                                                                                                                </h4>
                                                                                                                <div className="flip-content">
                                                                                                                {teamData.workingShifts.flipBackDesc1}
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            {/* .flip-back-inner */}
                                                                                                        </div>
                                                                                                    ...
                                                                                                    <div className="flip-box-inner imghvr-flip-horiz">
                                                                                                        <div className="flip-front">
                                                                                                            <div className="flip-front-inner">
                                                                                                                ...
                                                                                                                <h4 className="flip-box-title">
                                                                                                                {teamData.workingShifts.flipFront2}
                                                                                                                </h4>
                                                                                                                <div className="flip-content">
                                                                                                                {teamData.workingShifts.flipFrontDesc2}
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            {/* .flip-front-inner */}
                                                                                                        </div>
                                                                                                        ...
                                                                                                        <div className="flip-back">
                                                                                                            <div className="flip-back-inner">
                                                                                                                ...
                                                                                                                <h4 className="flip-box-title">
                                                                                                                {teamData.workingShifts.flipBack2}
                                                                                                                </h4>
                                                                                                                <div className="flip-content">
                                                                                                                {teamData.workingShifts.flipBackDesc2}
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            {/* .flip-back-inner */}
                                                                                                        </div>
