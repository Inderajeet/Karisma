...
const Machines = () => {
  ...
  const machines = slimming?.machines;
  ...
  return (
    <div>
      ...
      <Blog
        ...
        blogTitle={machines.blog1?.title}
        blogDesc={machines.blog1?.description}
        // additionalParagraphs={[machines.blog1?.content]}
      />
      <OralSurgeryProcedure procedures={machines?.paras} />

       <ParaSection style={{backgroundColor:"transparent", marginTop:"50px"}} title={machines?.para_sec1?.title} desc={machines?.para_sec1?.description} />
      <div style={styles.container}>
        <h1 style={styles.mainTitle}>{machines?.para_sec1?.title}</h1>
        {machines?.para_sec1?.description?.map((desc, index) => (
          <p
            key={index}
        ...
        <div style={styles.procedureList}>
          {machines?.para_sec1?.content?.map((procedure, index) => (
      ...
      <ParaSection title={machines?.para_sec2?.title} desc={machines?.para_sec2?.description} extraContent={<DoctorGrid data={machines?.para_sec2?.content} />} />
    </div>
  );
};
